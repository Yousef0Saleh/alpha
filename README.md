...
[API routes](https://nextjs.org/docs/api-routes/introduction) can be accessed on [http://192.168.1.5:3000/api/hello](http://192.168.1.5:3000/api/hello). This endpoint can be edited in `pages/api/hello.ts`.
